...
class SchemalockLspServerDescriptor(project: Project, private val pluginPath: Path) :
    ...
    override fun createCommandLine(): GeneralCommandLine =
        GeneralCommandLine(BinaryResolver.resolve(pluginPath).absolutePath, "serve", "--stdio")
